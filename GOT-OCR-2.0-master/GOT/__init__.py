...
def init_model_GOT(model_name):
    ...
    # vllm形式加载,生产环境需要设置enforce_eager为False
    model = LLM(model=model_name, max_model_len=8192, trust_remote_code=True, enforce_eager=False, gpu_memory_utilization=0.85)
